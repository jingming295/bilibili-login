...
export class BiliBiliVideoApi extends sendFetch
{
        ...
        )
    {
        ...
        {
            this.logger.warn(`getInteractiveVideoDetail: ${response.statusText} code: ${response.status}`);
            return null;
        }
    ...
    public async getHighEnergyBarList(cid: number, aid: number | null = null, bvid: string | null = null)
    {
        ...
        {
            this.logger.warn(`getHighEnergyBarList: ${response.statusText} code: ${response.status}`);
            return null;
        }
    }
    ...
    public async setViewHistory(aid: number, cid: number, progress: number = 0, platform: string = ''): Promise<reportResult | null>
    {
        ...
        {
            this.logger.warn(`setViewHistory: ${response.statusText} code: ${response.status}`);
            return null;
        }
    }
        ...
        )
    {
        ...
        {
            this.logger.warn(`postHeartbeat: ${response.statusText} code: ${response.status}`);
            return null;
        }
    }
    ...
    public async getCurrentOnlineViewers(aid: number | null = null, bvid: string | null = null, cid: number)
    {
        ...
        {
            this.logger.warn(`getCurrentOnlineViewers: ${response.statusText} code: ${response.status}`);
            return null;
        }
    }
    ...
    public async getAppealType()
    {
        ...
        {
            this.logger.warn(`getAppealType: ${response.statusText} code: ${response.status}`);
            return null;
        }
    }
        ...
        )
    {
        ...
        {
            this.logger.warn(`makeAppeal: ${response.statusText} code: ${response.status}`);
            return null;
        }
    }
